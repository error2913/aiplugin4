...
| MEM-02 | `.ai memo status` | U | `长期记忆开启状态`、`总结记忆` | 快照命令 |
...
| MEM-12 | `.ai memo sum on` | S | `总结记忆已开启` | |
| MEM-13 | `.ai memo sum off` | S | `总结记忆已关闭` | |
| MEM-14 | `.ai memo sum list` | S | `总结记忆为空` 或 `当前页码` | |
| MEM-15 | `.ai memo sum clr` | S | `总结记忆已清除` | 自清理 |
