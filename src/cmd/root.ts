...
import { CmdPrivInfo, PrivilegeManager, U } from "./privilege";
...
export const cmd = seal.ext.newCmdItemInfo();
cmd.name = 'ai';
cmd.help = `帮助:
【.ai priv】权限相关
...
cmd.solve = (ctx, msg, cmdArgs) => {
    try {
        ...
        const scc: SubCmdContext = { ctx, msg, cmdArgs, epId, uid, gid, sid, ai, page, ret };
